...
@interface ViewController () <ReceiptProtocol>
...
- (void)insertNewObject:(id)sender {
    ...
    [newReceipt setValue:[NSDate date] forKey:@"timeStamp"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"newReceipt"]) {
        CreateReceiptViewController *controller = segue.destinationViewController;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ReceiptCell *cell = [tableView dequeueReusableCellWithIdentifier:@"receiptCell" forIndexPath:indexPath];
...
- (void)configureCell:(ReceiptCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    Receipt *object = [self.fetchedResultsController objectAtIndexPath:indexPath];
    
    cell.timeStamp.text = [object.timeStamp description];
    cell.amount.text = [NSString stringWithFormat:@"%.2f", [object.amount floatValue]];
    cell.receiptDescription.text = [object valueForKey:@"receiptDescription"];
}
